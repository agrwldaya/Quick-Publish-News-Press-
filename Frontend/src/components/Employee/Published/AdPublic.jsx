...
export default function AdPublish() {
  ...
  const FilteredData = adNewsData.filter((ad) => ad.status === 'published');
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-100 to-gray-200 p-8">
      <h1 className="text-4xl font-bold text-center mb-8 text-gray-800">Published  Advertisements</h1>
